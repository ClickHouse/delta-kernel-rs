...
fn table_changes_scan_iter_init_impl(
    ...
    /// FIXME: How to get rid of this table_changes_iter.collect? Without it I get
    /// "coercion requires that `table_changes_scan` is borrowed for `'static`"
...
/// [`scan_table_changes_iter_init`].
#[no_mangle]
pub unsafe extern "C" fn free_scan_table_changes_iter(data: Handle<SharedScanTableChangesIterator>) {
    data.drop_handle();
}
